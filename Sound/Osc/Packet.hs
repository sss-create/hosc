...
-- | Retrieve the set of 'Bundle's from a 'Packet'.
packetBundles :: PacketOf Bundle -> [Bundle]
packetBundles = bundleMessages . packetBundle

--xpacketBundles :: BundleOf (PacketOf Bundle) -> [Bundle]
--xpacketBundles = bundleMessages . packetBundle
